...
%type <charval> declarator initializer declaration_specifiers
%type <args> init_declarator_list init_declarator declaration
...
primary_expression                                                                                                                                                                
	: IDENTIFIER																		{ printf("--> %s primary_expression/IDENTIFIER (Col:%d,Ln:%d) %d\n",$1,column+1,line+1,i++); }        
	| CONSTANT																			{ printf("--> %s primary_expression/CONSTANT (Col:%d,Ln:%d) %d\n",$1,column+1,line+1,i++); }          
